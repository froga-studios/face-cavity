...
public class WitherSkeletonFaceCavity extends BaseFaceCavity implements FaceCavityType {
    @Override
    public void fillFaceCavityInventory(FaceCavityInventory faceCavity) {
        faceCavity.clear();
        faceCavity.setStack(0, ItemStack.EMPTY);
        ...
        faceCavity.setStack(8, ItemStack.EMPTY);
        faceCavity.setStack(9, ItemStack.EMPTY);
        ...
        faceCavity.setStack(17, ItemStack.EMPTY);
        faceCavity.setStack(18, ItemStack.EMPTY);
        faceCavity.setStack(19, ItemStack.EMPTY);
        faceCavity.setStack(20, ItemStack.EMPTY);
        faceCavity.setStack(21, ItemStack.EMPTY);
        faceCavity.setStack(22, ItemStack.EMPTY);
        faceCavity.setStack(23, ItemStack.EMPTY);
        faceCavity.setStack(24, ItemStack.EMPTY);
        faceCavity.setStack(25, ItemStack.EMPTY);
        faceCavity.setStack(26, ItemStack.EMPTY);
    }
