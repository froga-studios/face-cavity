...
public class GhastFaceCavity extends BaseFaceCavity implements FaceCavityType {
    @Override
    public void fillFaceCavityInventory(FaceCavityInventory faceCavity) {
        ...
        faceCavity.setStack(1, new ItemStack(CCItems.GAS_BLADDER, CCItems.GAS_BLADDER.getMaxCount()));
        faceCavity.setStack(2, new ItemStack(CCItems.ANIMAL_APPENDIX, CCItems.ANIMAL_APPENDIX.getMaxCount()));
        faceCavity.setStack(3, new ItemStack(CCItems.GAS_BLADDER, CCItems.GAS_BLADDER.getMaxCount()));
        faceCavity.setStack(4, new ItemStack(CCItems.ANIMAL_HEART, CCItems.ANIMAL_HEART.getMaxCount()));
        faceCavity.setStack(5, new ItemStack(CCItems.GAS_BLADDER, CCItems.GAS_BLADDER.getMaxCount()));
        faceCavity.setStack(6, ItemStack.EMPTY);
        faceCavity.setStack(7, new ItemStack(CCItems.GAS_BLADDER, CCItems.GAS_BLADDER.getMaxCount()));
        ...
        faceCavity.setStack(11, new ItemStack(CCItems.ANIMAL_SPLEEN, CCItems.ANIMAL_SPLEEN.getMaxCount()));
        ...
        faceCavity.setStack(22, new ItemStack(CCItems.VOLATILE_STOMACH, CCItems.VOLATILE_STOMACH.getMaxCount()));
    ...
    public void loadBaseOrganScores(Map<Identifier, Float> organScores){
        organScores.clear();
        organScores.put(FCOrganScores.BUOYANT,-4f);
    }
    @Override
