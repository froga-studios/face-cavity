...
public class CaveSpiderFaceCavity extends BaseFaceCavity implements FaceCavityType {
    @Override
    public void fillFaceCavityInventory(FaceCavityInventory faceCavity) {
        ...
        faceCavity.setStack(18, new ItemStack(CCItems.VENOM_GLAND, CCItems.VENOM_GLAND.getMaxCount()));
        ...
        faceCavity.setStack(25, new ItemStack(CCItems.INSECT_MUSCLE, CCItems.INSECT_MUSCLE.getMaxCount()));
