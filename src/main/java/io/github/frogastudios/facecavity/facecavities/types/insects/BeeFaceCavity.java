...
public class BeeFaceCavity extends BaseFaceCavity implements FaceCavityType {
    @Override
    public void fillFaceCavityInventory(FaceCavityInventory faceCavity) {
        ...
        faceCavity.setStack(25, new ItemStack(CCItems.VENOM_GLAND, CCItems.VENOM_GLAND.getMaxCount()));
        faceCavity.setStack(26, new ItemStack(CCItems.VENOM_GLAND, CCItems.VENOM_GLAND.getMaxCount()));
    }
