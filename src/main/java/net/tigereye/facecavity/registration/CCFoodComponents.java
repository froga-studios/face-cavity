...
public class CCFoodComponents {
    ...
    public static final FoodComponent HUMAN_MUSCLE_FOOD_COMPONENT = new FoodComponent.Builder().hunger(2).saturationModifier(.4f).meat().snack()
            .statusEffect(new StatusEffectInstance(StatusEffects.SLOWNESS, 24000, 1), FaceCavity.config.RISK_OF_PRIONS).statusEffect(new StatusEffectInstance(StatusEffects.MINING_FATIGUE, 24000, 1), FaceCavity.config.RISK_OF_PRIONS).statusEffect(new StatusEffectInstance(StatusEffects.WEAKNESS, 24000, 1), FaceCavity.config.RISK_OF_PRIONS).build();
    ...
    public static final FoodComponent COOKED_MAN_MEAT_FOOD_COMPONENT = new FoodComponent.Builder().hunger(4).saturationModifier(.8f).meat()
            .statusEffect(new StatusEffectInstance(StatusEffects.SLOWNESS, 24000, 0), FaceCavity.config.RISK_OF_PRIONS).statusEffect(new StatusEffectInstance(StatusEffects.MINING_FATIGUE, 24000, 0), FaceCavity.config.RISK_OF_PRIONS).statusEffect(new StatusEffectInstance(StatusEffects.WEAKNESS, 24000, 0), FaceCavity.config.RISK_OF_PRIONS).build();
