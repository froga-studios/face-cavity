...
public class CCKeybindings {
    ...
    public static Identifier UTILITY_ABILITIES_ID = new Identifier(FaceCavity.MODID,"utility_abilities");
    public static List<Identifier> UTILITY_ABILITY_LIST = new ArrayList<>();
    public static KeyBinding ATTACK_ABILITIES;
    public static Identifier ATTACK_ABILITIES_ID = new Identifier(FaceCavity.MODID,"attack_abilities");
